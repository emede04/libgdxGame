...
public class JoyStick {
    ...
    public JoyStick() {
        ...
        final Image tiroimg = new Image(new Texture("tiro.png"));
        tiroimg.setSize(50, 50);

        tiroimg.addListener(new InputListener() {
        ...
        table.add(tiroimg).size(upImg.getWidth(), upImg.getHeight());;
